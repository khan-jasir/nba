...
class Overdue extends StatelessWidget {
  const Overdue({super.key, this.activities, this.filter});
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ActivtitySort(
              filter: filter,
              activitySegregatorType: ActivitySegregatorEnum.overdue,
            ),
                ...
                ActivityAccordion(
                  activities:
                      activities!.highList.map((element) {
                        return ActivityTile(
                          activity: element,
                          activitySegregator: ActivitySegregatorEnum.overdue,
                        );
                      }).toList(),
